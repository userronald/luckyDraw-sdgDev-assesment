...
export default function LuckyDraw() {
  ...
  return (
    ...
    `}
              ...
              {/* Result text + instructions — ONLY show when NOT a win */}
              {!isWin && (
            ...
            {/* BASE NEON U-CURVE + LINES BEHIND THE 6 COLUMNS */}
            ...
            <div className="w-full flex justify-center items-end">
              ...
              <img
                ...
                alt="bg scale"
                className="absolute top-75 left-1/2 -translate-x-1/2 
               w-[130%] md:w-[130%] lg:w-[90%] 
               z-0 pointer-events-none select-none"
              />
              <div className="w-full max-w-4xl">
                <div className="flex justify-between gap-1 px-1 md:px-2">
                  {columns.map((num, idx) => {
      ...
      w-28 h-44 rounded-xl border-2 border-[#ec8ef9] 
      bg-[rgba(60,17,93,0.92)] backdrop-blur-xl 
      flex items-center justify-center text-5xl font-bold
      text-[#7df3ff] shadow-[0_0_18px_#ec8ef9]
      ${isSpinning ? "animate-spinSlow opacity-60" : ""}
      ${isWin && num === WIN_NUMBER ? "animate-glowWin scale-110" : ""}
    `}
                            style={{
                              filter:
                                "drop-shadow(0 8px 22px rgba(20,10,40,0.22))",
                              zIndex: 10,
                            }}
                          >
                            {/* Your number code */}
                            <div className="relative z-20 h-full flex items-center justify-center">
                              <div
                                className="text-4xl md:text-8xl font-extrabold tracking-wide"
                                style={{
                                  color: "#9fe8ff",
